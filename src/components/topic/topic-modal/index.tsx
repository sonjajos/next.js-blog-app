...
export default function TopicModal({ slug, button, defaultValues }: TopicModalProps) {
      ...
      {button ? (
        ...
        <Button className='border-none bg-[transparent]' onPress={onOpen}>
          <div className='flex flex-row gap-2'>
            ...
            <div className='buttonText'>Add Topic</div>
          </div>
        </Button>
      )}
      <Modal
        ...
        <ModalContent>
          {() => (
            <>
              ...
              <ModalBody>
                <TopicForm defaultValues={defaultValues} slug={slug} handleClose={onClose} />
              </ModalBody>
            </>
          )}
        </ModalContent>
